...
public class FollowingLookup {
    ...
    public void test() throws IOException, URISyntaxException {
        ...
        if (null != bearerToken) {
            ...
            String response = getFollowing("1353959290596331523", bearerToken);
     ...
     * */
    private String getFollowing(String userId, String bearerToken) throws IOException, URISyntaxException {
